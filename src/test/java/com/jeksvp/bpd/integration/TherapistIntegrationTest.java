...
public class TherapistIntegrationTest {
    ...
    @Test
    public void emptyTherapistListForPatientAfterSignUp() throws Exception {
        String username = "emptyPatientTherapistsSignUp";
    ...
    public void notFoundTherapistListForTherapistAfterSignUp() throws Exception {
        String username = "emptyTherapistTherapistsSignUp";
